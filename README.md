...
module.exports = class Cart {
    ...
    static addProduct(id, productPrice) {
        ...
        fs.readFile(p, (err, fileContent) => {
            ...
            let updatedProduct;
            // 제품이 존재할 때는 qty 값을 올려주고, 아닐 때는 새로 object를 만든다.
            ...
            if(existingProduct) {
                ...
                cart.products = [...cart.products, updatedProduct]; //Spread Operator에서 뒤에 value를 하나 추가해주면 array에 값이 추가된다.
            }
...
기본적으로 ?id=1 이런 것을 `query param` 이라고 한다. 
